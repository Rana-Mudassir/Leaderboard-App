...
**[Leaderboard]**  allows you to mark main tasks listed by the user as complete. You can built a simple website that allows for doing that, and you will do it using ES6 with Webpack!
